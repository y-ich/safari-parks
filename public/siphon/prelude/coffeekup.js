(function() {
  ...
  skeleton = function(ck_options) {
    ...
    if ((_ref = ck_options.context) == null) {
      ck_options.context = {};
    }
    if ((_ref2 = ck_options.locals) == null) {
      ck_options.locals = {};
    }
    if ((_ref3 = ck_options.format) == null) {
      ck_options.format = false;
    }
    if ((_ref4 = ck_options.autoescape) == null) {
      ck_options.autoescape = false;
    }
    ck_buffer = [];
  ...
  coffeekup.render = function(template, options) {
    ...
    if ((_ref2 = options.locals) == null) {
      options.locals = {};
    }
    if ((_ref3 = options.cache) == null) {
      options.cache = true;
    }
